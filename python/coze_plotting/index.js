...
// 1. 设置内容
let content = `分镜图1：宁静的小镇公园描绘；早晨，微光透过树叶投影在长椅上。"胖橘猫"，这位穿着深褐色带有黑色条纹的侦探大衣和佩戴着传统格子图案侦探帽的"胖橘猫"，坐在椅子上，眼睛紧闭，手托下巴，沉浸在思考之中。
...
分镜图7：穿越小镇的"胖橘猫": "胖橘猫"身穿简洁的探险家装备，沿着镇里的小巷子走着。背景是溫馨的小镇风光，有着各式各样拱形的门窗和石头铺成的小径，远处是诱人的山丘。
分镜图8：黄昏下的山丘；"胖橘猫"站在山顶，夕阳的余晖洒在身上，给他那橘色的毛发涂上了金色的光辉。他的口袋中探出宝藏图的一角，眼睛仔细地观察着四周的风景，试图与手中的宝藏图相匹配。
...
分镜图6：准备出发的"胖橘猫"；戴着一顶红色的帽子，脚穿坚实的靴子，身后背着一只绿色的背包，上面绑着绳索和一个金属水壶。背包显得鼓鼓囊囊，装满了探险过程中可能需要的各种用品，"胖橘猫"站在家门口，神情期待而决绝。
分镜图9：洞穴入口处的"胖橘猫"；洞口光滑而诱人，在夕阳的照耀下显得神秘莫测。"胖橘猫"穿着一套勘探装备，头上戴着头灯，身边是他那个信赖的绿背包，正走进这个充满未知的洞穴。
分镜图17：宝藏地图与小镇照片；"胖橘猫"拿着地图碎片，光从室内昏暗的背景反射在它上面，使之看起来有种神秘的闪烁。背面是一张有着明显标记点的小镇照片，令"胖橘猫"顿时陷入思索。他身穿简洁的探险家装备，准备踏上新旅程的姿态。
分镜图10："胖橘猫"探索洞穴；洞穴内部深邃广阔，"胖橘猫"身穿简洁的探险家装备，打开头灯，黄色的光芒在洞中显得格外温暖。他一步步小心翼翼地探索，动作谨慎而充满好奇。
`
