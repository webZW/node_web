...
lines:function(a){return this._manyToFeatures(a,"LineString")},polygons:function(a){return this._manyToFeatures(a,"Polygon")},geoProperties:function(a){return a instanceof Array?this._setFeatureCollection(a):this._setFeature(a)},_setFeature:function(a){return{type:"geojson",data:{type:"Feature",properties:a.properties||{},geometry:a.geometry}}},_setFeatureCollection:function(a){var b={type:"geojson",data:{type:"FeatureCollection",features:[]}};try{for(var c=0;c<a.length;c++)b.data.features.push({type:"Feature",
properties:a[c].properties||{},geometry:a[c].geometry})}catch(d){throw"arr \u6570\u636e\u9519\u8bef!  [Point]|[[LineString]]|[[[Polygon]]]";}return b},CLASS_NAME:"GeoGlobe.Format.GeoJSONUtil"});
...
c=c.result,e=[];c.mid&&c.mid.split(";").forEach(function(a){e.push(a.split(","))});var a=c.routelatlon.split(";"),j=[];a.pop();a.forEach(function(a){j.push(a.split(","))});var l=[];Object.prototype.toString.call(c.simple)=="[object Object]"&&c.simple.item.forEach(function(a){var b=a.streetLatLon.split(";"),d=[];b.pop();b.forEach(function(a){d.push(a.split(","))});var b={type:"Feature",geometry:{type:"LineString",coordinates:d},properties:a,items:[]},e=a.segmentNumber.split("-");if(e.length>=2){a=
1+Number(e[1]);for(e=e[0];e<a;e++)b.items.push(c.routes.item[e])}else b.items.push(c.routes.item[e[0]]);l.push(b)});a={startLngLat:c.orig.split(","),midLngLat:e,endLngLat:c.dest.split(","),distance:c.distance,times:c.duration,mapinfo:{center:c.mapinfo.center.split(","),zoom:c.mapinfo.scale},routeLngLat:j,geojsonRoute:{type:"FeatureCollection",features:l}};a={originalData:c,processedData:a};b&&b(a)},function(a){c&&c(a)})},searchByBus:function(a,b,c){if(!a.start)throw Error("\u8d77\u70b9\u4e3a\u7a7a");
if(!a.end)throw Error("\u7ec8\u70b9\u4e3a\u7a7a");var d={startposition:a.start.join(","),endposition:a.end.join(","),linetype:a.style||1};a.mid&&a.mid.join(";");a={type:"busline",postStr:JSON.stringify(d),tk:this.token};GeoGlobe.loadURL("https://api.tianditu.gov.cn/transit",a,this,function(a){if(b){var a=JSON.parse(a.responseText),c="";a.resultCode==1?c="\u627e\u4e0d\u5230\u8d77\u70b9\u3002":a.resultCode==2?c="\u627e\u4e0d\u5230\u7ec8\u70b9\u3002":a.resultCode==3?c="\u89c4\u5212\u7ebf\u8def\u5931\u8d25\u3002":
a.resultCode==4?c="\u8d77\u7ec8\u70b9\u8ddd\u79bb200\u7c73\u4ee5\u5185\uff0c\u4e0d\u89c4\u5212\u7ebf\u8def\uff0c\u5efa\u8bae\u6b65\u884c\u3002":a.resultCode==5?c="\u8d77\u7ec8\u70b9\u8ddd\u79bb500\u7c73\u5185\uff0c\u8fd4\u56de\u7ebf\u8def\u3002":a.resultCode==6&&(c="\u8f93\u5165\u53c2\u6570\u9519\u8bef\u3002");c={resultCode:a.resultCode,errorMsg:c,data:[]};if(a.resultCode==0&&a.results.length){var d=[];a.results[0].lines.forEach(function(a){var b=a.lineName.split("|");b.pop();var c=[],e=0,f=0,p=0;
a.segments.forEach(function(a){var b=a.segmentLine[0],d=[];b.linePoint.split(";").forEach(function(a){d.push(a.split(","))});d.pop();e+=b.segmentTime;f+=b.segmentDistance;a.segmentType==1&&(p+=b.segmentDistance);c.push({type:"Feature",geometry:{type:"LineString",coordinates:d},properties:{segmentType:a.segmentType,stationStart:a.stationStart,stationEnd:a.stationEnd,SEndTime:b.SEndTime,byuuid:b.byuuid,segmentTransferTime:b.segmentTransferTime,direction:b.direction,lineName:b.lineName,segmentDistance:b.segmentDistance,
segmentStationCount:b.segmentStationCount,segmentTime:b.segmentTime}})});d.push({nameArr:b,lineItems:{type:"FeatureCollection",features:c},allTimes:e,walkingDistance:p,allDistance:f})});c.data=d}b({originalData:a,processedData:c})}},function(a){c&&c(a)})},searchLineOrStation:function(a,b,c){if(!a.uuid)throw Error("uuid\u4e3a\u7a7a");a={type:"busline",postStr:JSON.stringify({uuid:a.uuid}),tk:this.token};GeoGlobe.loadURL("https://api.tianditu.gov.cn/transit",a,this,function(a){if(b){var a=JSON.parse(a.responseText),
c=a.linepoint.split(";"),f=[];c.pop();c.forEach(function(a){f.push(a.split(","))});a.geojsonLine={type:"FeatureCollection",features:[{type:"Feature",geometry:{type:"LineString",coordinates:f}}]};var g={type:"FeatureCollection",features:[]};a.station.forEach(function(a){g.features.push({type:"Feature",geometry:{type:"Point",coordinates:a.lonlat.split(",")},properties:a})});a.geojsonStation=g;b(a)}},function(a){c&&c(a)})},searchBackRoute:function(a,b,c){if(!a.lineUuid)throw Error("lineUuid\u4e3a\u7a7a");
if(!a.stationUuid)throw Error("stationUuid\u4e3a\u7a7a");a={type:"busline",postStr:JSON.stringify({uuid:a.lineUuid,stationUuid:a.stationUuid}),tk:this.token};GeoGlobe.loadURL("https://api.tianditu.gov.cn/transit",a,this,function(a){if(b){var a=JSON.parse(a.responseText),c=a.linepoint.split(";"),f=[];c.pop();c.forEach(function(a){f.push(a.split(","))});a.geojsonLine={type:"FeatureCollection",features:[{type:"Feature",geometry:{type:"LineString",coordinates:f}}]};var g={type:"FeatureCollection",features:[]};
a.station.forEach(function(a){g.features.push({type:"Feature",geometry:{type:"Point",coordinates:a.lonlat.split(",")},properties:a})});a.geojsonStation=g;b(a)}},function(a){c&&c(a)})},parseXML:function(a){var b;if(window.DOMParser){b=new DOMParser;a=b.parseFromString(a,"application/xml");if(!a)return;b=a.documentElement}else if(window.ActiveXObject)b=new ActiveXObject("Microsoft.XMLDOM"),b.async=!1,b.loadXML(a),b=b.documentElement;if(b)return this._parseDOM(b)},_parseDOM:function(a){if(a){this.__force_array=
{};if(this.force_array)for(var b=0;b<this.force_array.length;b++)this.__force_array[this.force_array[b]]=1;b=this._parseElement(a);this.__force_array[a.nodeName]&&(b=[b]);if(a.nodeType!=11){var c={};c[a.nodeName]=b;b=c}return b}},_parseElement:function(a){if(a.nodeType!=7){if(a.nodeType==3||a.nodeType==4){if(a.nodeValue.match(/[^\x00-\x20]/)==null)return;return a.nodeValue}var b,c={};if(a.attributes&&a.attributes.length){b={};for(var d=0;d<a.attributes.length;d++){var e=a.attributes[d].nodeName;if(typeof e==
"string"){var f=a.attributes[d].nodeValue;f&&(typeof c[e]=="undefined"&&(c[e]=0),c[e]++,this._addNode(b,e,c[e],f))}}}if(a.childNodes&&a.childNodes.length){e=!0;b&&(e=!1);for(d=0;d<a.childNodes.length&&e;d++)f=a.childNodes[d].nodeType,f==3||f==4||(e=!1);if(e){b||(b="");for(d=0;d<a.childNodes.length;d++)b+=a.childNodes[d].nodeValue}else{b||(b={});for(d=0;d<a.childNodes.length;d++)if(e=a.childNodes[d].nodeName,typeof e=="string"&&(f=this._parseElement(a.childNodes[d])))typeof c[e]=="undefined"&&(c[e]=
0),c[e]++,this._addNode(b,e,c[e],f)}}return b}},_addNode:function(a,b,c,d){this.__force_array[b]?(c==1&&(a[b]=[]),a[b][a[b].length]=d):c==1?a[b]=d:c==2?a[b]=[a[b],d]:a[b][a[b].length]=d},CLASS_NAME:"GeoGlobe.Query.TDTRouteQuery"});
